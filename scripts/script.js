function exibeCandidatos(candidatos) {
  ...
  candidatos.map((candidato) => {
      html += "<div class='card'>" + '<h2>' + candidato.nome + '</h2><br><p>' + "Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis sequi incidunt enim magni dolorum numquam impedit voluptatem dolorem ea ipsum, provident tenetur eum voluptatibus culpa itaque, veritatis error maxime in!" + '</p><br>' 
